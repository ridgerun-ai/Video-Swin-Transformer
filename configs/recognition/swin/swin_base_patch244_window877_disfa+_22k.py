...
model=dict(backbone=dict(pretrained='../drowsiness-detector/weights/swin_base_patch244_window877_kinetics400_22k.pth', pretrained2d=False, patch_size=(2,4,4), drop_path_rate=0.2), test_cfg=dict(max_testing_views=2))
...
work_dir = './work_dirs/disfa+_swin_base_22k_patch244_window877.py'
